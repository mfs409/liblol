...
/**
 * The game starts with a splash screen, which has buttons for "PLAY", "HELP", and "QUIT". This file provides
 * configuration information for the splash screen.
 */
public class SplashConfig implements SplashConfiguration
{
    /**
     * The name of the image to display as the splash screen. Be sure to register this image in your main java file.
     */
    @Override
    ...
    /**
     * The name of the music to play while the splash screen is showing. Be sure to register this file in your main java
     * file.
     */
    @Override
    ...
    /**
     * The X coordinate of the bottom left corner of the "PLAY" button. If you're not sure, click on the screen, and
     * your 'console' in Eclipse should tell you the coordinate where you clicked.
     */
    public int getPlayX()
    {
        return 82;
