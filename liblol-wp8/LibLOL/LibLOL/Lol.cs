...
namespace LibLOL
{
    ...
    public abstract class Lol : Game
    {
        ...
        // START LOL PUBLIC INTERFACE

        public abstract LolConfiguration LolConfig();

        public abstract ChooserConfiguration ChooserConfig();

        // Have to think about the name resource method. Need to somehow tie it to the LoadContent method
        // that is called automatically at runtime
        ...
        // Still methods left to implement, but are dependant on other classes.
