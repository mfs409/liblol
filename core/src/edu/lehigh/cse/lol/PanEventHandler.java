...
/**
 * PanEventHandler is a wrapper for code that ought to run in response to a pan event.
 */
public abstract class PanEventHandler {
    ...
    /**
     * The go() method encapsulates the code that should be run in response to a pan event.
     *
