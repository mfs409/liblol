...
class ParallaxLayer {
    ...
    /**
     * Construct a ParallaxLayer by getting everything ready for a ParallaxLayer to use it
     *
     ...
     */
    public ParallaxLayer(float xSpeed, float ySpeed, TextureRegion tr, float xOffset, float yOffset,
