...
namespace LOL
{
    public class Util
    {
         ...
         */
        public static Renderable makePicture(float x, float y, float width,
            ...
            r.render = delegate(SpriteBatch sb, GameTime gameTime) {
                    if (tr != null)
         ...
         */
        public static Renderable makeText(int x, int y, String message, int red,
                int green, int blue, String fontName, int size) {
            Font bf = Media.getFont(fontName, size);
            Renderable r= new Renderable();
            r.render = delegate(SpriteBatch sb, GameTime elapsed) {
