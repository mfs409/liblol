...
namespace FarseerPhysics.Factories
{
    public static class BodyFactory
    {
        ...
        public static Body CreateBody(World world, Vector2 position, float rotation)
        {
            return CreateBody(world, position, rotation, null);
        }

        public static Body CreateBody(World world, Vector2 position, float rotation, object userData)
        {
        ...
        public static Body CreateChainShape(World world, Vertices vertices, Vector2 position, object userData)
        {
        ...
        public static Body CreateLoopShape(World world, Vertices vertice)
        {
            return CreateLoopShape(world, vertice, null);
        }
        ...
        public static Body CreateRectangle(World world, float width, float height, float density, Vector2 position, object userData)
        {
            ...
            newBody.CreateFixture(rectangleShape, null);
                                         ...
                                         object userData)
        {
            ...
            body.CreateFixture(topCircle, null);

            CircleShape bottomCircle = new CircleShape(endRadius, density);
            bottomCircle.Position = new Vector2(0, -(height / 2));
            body.CreateFixture(bottomCircle, null);
            return body;
        }
