...
namespace FarseerPhysics.Dynamics
{
    ...
    public class Body : IDisposable
    {
        ...
        public Body(World world, Vector2? position): this(world, position, 0)
        {
        }
        public Body(World world, Vector2? position, float rotation): this(world, position, rotation, null)
        {

        }

        public Body(World world, Vector2? position, float rotation, object userdata)
        {
