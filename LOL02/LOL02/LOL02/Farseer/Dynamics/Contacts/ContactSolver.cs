...
namespace FarseerPhysics.Dynamics.Contacts
{
    ...
    public class ContactSolver
    {
        ...
        {
            Reset(step, count, contacts, positions, velocities, Settings.EnableWarmstarting);
        }

        public void Reset(TimeStep step, int count, Contact[] contacts, Position[] positions, Velocity[] velocities, bool warmstarting)
        {
            _step = step;
            _count = count;
