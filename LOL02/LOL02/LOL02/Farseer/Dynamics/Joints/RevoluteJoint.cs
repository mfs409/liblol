...
namespace FarseerPhysics.Dynamics.Joints
{
    ...
    public class RevoluteJoint : Joint
    {
        ...
        public RevoluteJoint(Body bodyA, Body bodyB, Vector2 anchorA, Vector2 anchorB)
            : this(bodyA, bodyB, anchorA, anchorB, false)
        {
        ...
        public RevoluteJoint(Body bodyA, Body bodyB, Vector2 anchorA, Vector2 anchorB, bool useWorldCoordinates)
            : base(bodyA, bodyB)
        {
            JointType = JointType.Revolute;
        ...
        public RevoluteJoint(Body bodyA, Body bodyB, Vector2 anchor, bool useWorldCoordinates)
