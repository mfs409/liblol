...
namespace FarseerPhysics.Dynamics.Joints
{
    ...
    public class WheelJoint : Joint
    {
        ...
        public WheelJoint(Body bodyA, Body bodyB, Vector2 anchor, Vector2 axis)
        ...
        public WheelJoint(Body bodyA, Body bodyB, Vector2 anchor, Vector2 axis, bool useWorldCoordinates)
            : base(bodyA, bodyB)
        {
            JointType = JointType.Wheel;
