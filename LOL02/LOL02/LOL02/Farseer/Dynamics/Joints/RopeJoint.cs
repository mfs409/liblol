...
namespace FarseerPhysics.Dynamics.Joints
{
    ...
    public class RopeJoint : Joint
    {
        ...
        public RopeJoint(Body bodyA, Body bodyB, Vector2 anchorA, Vector2 anchorB):this(bodyA, bodyB, anchorA, anchorB, false)
        {
        ...
        public RopeJoint(Body bodyA, Body bodyB, Vector2 anchorA, Vector2 anchorB, bool useWorldCoordinates)
            : base(bodyA, bodyB)
        {
            JointType = JointType.Rope;
