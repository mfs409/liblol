...
namespace FarseerPhysics.Dynamics.Joints
{
    ...
    public class PulleyJoint : Joint
    {
        ...
        public PulleyJoint(Body bodyA, Body bodyB, Vector2 anchorA, Vector2 anchorB, Vector2 worldAnchorA, Vector2 worldAnchorB, float ratio)
            : this(bodyA, bodyB, anchorA, anchorB, worldAnchorA, worldAnchorB, ratio, false)
        {
        }
        ...
        public PulleyJoint(Body bodyA, Body bodyB, Vector2 anchorA, Vector2 anchorB, Vector2 worldAnchorA, Vector2 worldAnchorB, float ratio, bool useWorldCoordinates)
            : base(bodyA, bodyB)
        {
            JointType = JointType.Pulley;
