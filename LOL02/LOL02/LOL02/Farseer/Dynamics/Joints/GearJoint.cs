...
namespace FarseerPhysics.Dynamics.Joints
{
    ...
    public class GearJoint : Joint
    {
        ...
        public GearJoint(Body bodyA, Body bodyB, Joint jointA, Joint jointB)
            : this(bodyA, bodyB, jointA, jointB, 1f)
        {
        ...
        public GearJoint(Body bodyA, Body bodyB, Joint jointA, Joint jointB, float ratio)
        {
