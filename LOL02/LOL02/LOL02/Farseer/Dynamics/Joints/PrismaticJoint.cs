...
namespace FarseerPhysics.Dynamics.Joints
{
    ...
    public class PrismaticJoint : Joint
    {
        ...
        public PrismaticJoint(Body bodyA, Body bodyB, Vector2 anchorA, Vector2 anchorB, Vector2 axis)
            : this(bodyA, bodyB, anchorA, anchorB, axis, false)
        {
        ...
        public PrismaticJoint(Body bodyA, Body bodyB, Vector2 anchorA, Vector2 anchorB, Vector2 axis, bool useWorldCoordinates)
            : base(bodyA, bodyB)
        {
        ...
        public PrismaticJoint(Body bodyA, Body bodyB, Vector2 anchor, Vector2 axis)
            :this(bodyA,bodyB,anchor,axis,false)
        {

        }

        public PrismaticJoint(Body bodyA, Body bodyB, Vector2 anchor, Vector2 axis, bool useWorldCoordinates)
            : base(bodyA, bodyB)
        {
