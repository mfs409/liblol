    ...
    public class BreakableBody
    {
        ...
        public BreakableBody(IEnumerable<Vertices> vertices, World world, float density)
        {
            ...
            foreach (Vertices part in vertices)
            {
                ...
                Fixture fixture = MainBody.CreateFixture(polygonShape, null);
                Parts.Add(fixture);
            }
        }
        ...
        public BreakableBody(IEnumerable<Shape> shapes, World world)
        {
            ...
            {
                Fixture fixture = MainBody.CreateFixture(part, null);
                Parts.Add(fixture);
            }
        }
        ...
        private void Decompose()
        {
            ...
            for (int i = 0; i < Parts.Count; i++)
            {
                ...
                Fixture newFixture = body.CreateFixture(shape, null);
