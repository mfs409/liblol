...
namespace FarseerPhysics.Common.Decomposition
{
    ...
    public static class Triangulate
    {
        ...
        {
            return ConvexPartition(vertices, algorithm, true, 0.001f);
        }

        public static List<Vertices> ConvexPartition(Vertices vertices, TriangulationAlgorithm algorithm, bool discardAndFixInvalid)
        {
            return ConvexPartition(vertices, algorithm, discardAndFixInvalid, 0.001f);
        }

        public static List<Vertices> ConvexPartition(Vertices vertices, TriangulationAlgorithm algorithm, bool discardAndFixInvalid, float tolerance)
        {
            if (vertices.Count <= 3)
