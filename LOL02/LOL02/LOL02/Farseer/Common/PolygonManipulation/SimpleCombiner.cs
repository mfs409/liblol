...
namespace FarseerPhysics.Common.PolygonManipulation
{
    ...
    public static class SimpleCombiner
    {
        ...
        {
            return PolygonizeTriangles(triangles, int.MaxValue, 0.001f);
        }
        /// <summary>
        ...
        public static List<Vertices> PolygonizeTriangles(List<Vertices> triangles, int maxPolys, float tolerance)
        {
