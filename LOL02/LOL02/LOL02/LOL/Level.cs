...
namespace LOL
{
    public class Level: GameScreen
    {
         ...
         */
        private SpriteBatch mSpriteBatch = new SpriteBatch(Lol.GD);
        ...
        public class ParallaxCamera: OrthographicCamera {
            ...
            public Matrix calculateParallaxMatrix(float parallaxX, float parallaxY) {
                ...
                // NOTE: Check code below (was originally Matrix.Multiply)
                //Matrix.Multiply(parallaxCombined, parallaxView);
        ...
        public void Draw (GameTime gameTime) {
            ...
            // clear the screen
            Lol.GD.Clear(mBackground.mColor);
