...
namespace LOL
{
    ...
    {
        /**
         * Screen manager for switching screens
         */
        public static ScreenManager Screen;

        /**
         * Global GameTime object for precipitating updates from 
         * calls to XNA/MonoGame's Update to objects that use it
         */
        public static GameTime GlobalGameTime;

        /**
         * Globally calculated FPS
         */
